...
use sp_runtime::{
	...
	traits::{
		BlakeTwo256, Block as BlockT, Extrinsic as ExtrinsicT, IdentifyAccount, NumberFor, One,
		Verify,
	},
...
mod runtime {
	...
	pub type ExampleOffchainWorker = pallet_example_offchain_worker;

	#[runtime::pallet_index(10)]
	pub type RandomnessCollectiveFlip = pallet_insecure_randomness_collective_flip;

	#[runtime::pallet_index(11)]
	pub type Collectibles = collectibles;
}
